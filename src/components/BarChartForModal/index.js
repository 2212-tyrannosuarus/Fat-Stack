...
const BarChartForModal = (props) => {
  const { chartData, average, setAverage } = props;
  ...
  return (
    <div className="container">
      ...
      barChartDebit ? (
          ...
          <div className="col-12 p-0 border">
            ...
            >
              <VictoryLegend
                ...
                data={[
                  {
                    name: `Historically you've spent about $${average.toFixed(
                      2
                    )} \n on ${
                      chartData.flat().slice(0, -1)[0].subcategoryName
                    }`,
                  },
                ]}
        ...
        <img
          src="./assets/placeholderGraph.png"
          width="300"
          height="800"
          alt=""
          className="mt-4 pt-4"
