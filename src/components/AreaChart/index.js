...
const AreaChart = () => {
  ...
  useEffect(() => {
    async function drawChart() {
      ...
      if (chartDiv.hasChildNodes()) {
        let childNode = document.getElementById("chart").firstChild;
        chartDiv.removeChild(childNode);
      }
      ...
      chart.subscribeCrosshairMove(function (param) {
        ...
        let time = param.seriesData.get(areaSeries).time;
        ...
        var price = param.seriesData.get(areaSeries).value;
  ...
  return <div ref={chartContainerRef} id="chart" />;
};
